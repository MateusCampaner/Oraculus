...
from inserir_analise.views import inserir_analise, salvar_algoritmo_analise, treinar_algoritmo, configura_algoritmo #rodar_algoritmo_analise,rodar_analise, roda_analise_solo, detalhes_analise_solo
